...
const Header = () => {
  ...
  return (
    <div className=" bg-textcolor-0 sm:w-full sm:rounded-b-[30px] text-background-0 sm:h-8 sm:text-center lg:bg-header-bg lg:w-[100%] lg:h-16 lg:text-[22px] lg:text-center ">
