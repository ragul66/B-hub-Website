...
const ServiceItem = ({ imgSrc, imgAlt, description, alignRight }) => {
  const imageClass = `lg:w-[500px] lg:rounded-3xl lg:mt-48 ${
    alignRight ? "lg:ml-[900px]" : "lg:ml-16"
  }`;

  const textClass = `lg:font-primary lg:text-textcolor-0 ${
    alignRight ? "lg:text-right lg:mr-28" : "lg:ml-[750px]"
  } lg:-mt-44`;
