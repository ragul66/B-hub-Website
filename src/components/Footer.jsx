  ...
  return (
    <div className="  lg:bg-background-0 lg:w-full ">
      <div className="sm: text-textcolor-0 sm: font-primary  lg:font-primary ">
        ...
        <button
          className="text-textcolor-0 border-2 text-[25px] px-3 rounded-full border-textcolor-0 hover:bg-textcolor-0 hover:font-semibold hover:text-background-0"
          onClick={handlecontact}
        >
          ContactUs
        </button>
        <p className="text-center -mt-6 text-[15px]">
          Cpoyrights@ B-Hub Consultancy & Services
        </p>
      </div>
      <Whatsapp />
    </div>
